...
describe("NewPost component unit tests", () => {
  ...
  test("should have 3 inputs", () => {
    ...
    const input1 = screen.getByPlaceholderText("Enter type of your animal", {
      exact: false,
    });
    expect(input1).toBeInTheDocument();

    const input2 = screen.getByPlaceholderText("Enter your title", {
      exact: false,
    });
    expect(input2).toBeInTheDocument();

    const input3 = screen.getByPlaceholderText("Enter your contacts", {
      exact: false,
    });
  ...
  test('should have input with type - "file"', () => {
    ...
    const inputFile = screen.getByPlaceholderText("Choose an image", {
      exact: false,
    });
